...
public class MainActivity extends AppCompatActivity {
    ...
    private String BASE_URL = "http://10.0.2.2:3300"; // - adress for android studio emulator  //"http://192.168.56.1:3000"; // - adress of my pc host "http://localhost:3000";
                ...
                call.enqueue(new Callback<LoginResult>() {
                    ...
                    public void onResponse(Call<LoginResult> call, Response<LoginResult> response) {
                        ...
                        if (response.code() == 200) {
                            ...
                            builder1.setTitle("Logging in as "+ result.getUsername());
                            builder1.setMessage("Logging in...");
                            builder1.show();
